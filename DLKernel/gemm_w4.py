...
by a :class:`~DLKernel.operand_transform.TransformAW4`), the bf16 activations
are B, and the output is written transposed (D is (N, M) m-major = out
row-major). See DLKernel/operand_transform/formats/ for the formats and
DLKernel/blockscaled/nvfp4_utils.py for the repack layout.
...
DLKernel.operand_transform.host.pick_w4_cfg), and the split-k buffer reuse.
"""
...
from DLKernel.epilogue.ops import ColVecLoad, RowVecLoad
...
from DLKernel.operand_transform.host import (
