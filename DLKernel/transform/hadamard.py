...
from DLKernel import copy_utils, layout_utils
from DLKernel.cache import jit_cache
from DLKernel.compile_utils import make_fake_tensor as fake_tensor
from DLKernel.cute_dsl_utils import get_device_multiprocessor_count, torch2cute_dtype_map
...
class HadamardTransformPlan:
    ...
    def __init__(
        ...
        if tail_direct_store_enabled is None:
            tail_direct_store_enabled = os.getenv("DLKERNEL_HADAMARD_TAIL_DIRECT_STORE", "1") != "0"
...
@cute_op(
    "dlkernel::_hadamard_transform_fwd",
    mutates_args={"out"},
    device_types="cuda",
)
