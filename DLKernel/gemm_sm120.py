...
#   see DLKernel/blockscaled/nvfp4_utils.py `_arch_has_bf16_narrow_cvt`.
...
from DLKernel.varlen_utils import VarlenManager
from DLKernel.pipeline import make_pipeline_state
from DLKernel import copy_utils
from DLKernel.gemm_sm90 import GemmSm90, NamedBarrierGemm
from DLKernel.gemm_config import SplitKMode
from DLKernel.tile_scheduler import ag_wait_m_tile
from DLKernel import sm80_utils
...
class GemmSm120(GemmSm90):
    ...
    A-operand transforms (DLKernel/operand_transform/) are supported through the
    ...
    including the DLKernel.pipeline_checks arrive-count validation at construction.
    ...
    def __init__(
        ...
        # (DLKernel/operand_transform/) plug into the same copy_block seam as
    ...
    def _sfd_row_reqs(self, epilogue_args):
        ...
        the shared scan (DLKernel.epilogue.quantize_out.active_row_sfd_reqs)
    ...
    def _setup_attributes(self, epilogue_args):
        ...
        from DLKernel.epilogue.quantize_out import BlockScaleFactorStore
    ...
    def _setup_tiled_mma(self):
        ...
        sm_120a/f, sm_121a/f), so the H100 CI proxy legs (DLKERNEL_ARCH=120
