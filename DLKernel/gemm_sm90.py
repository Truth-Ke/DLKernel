...
from DLKernel.gemm_base import GemmTmaBase, NamedBarrierGemm, reinterpret_packed_fp6
from DLKernel.gemm_config import SplitKMode
from DLKernel.operand_transform.transform import TransformAOperand
from DLKernel.tile_scheduler import TileSchedulerOptions, ag_wait_m_tile
from DLKernel.varlen_utils import VarlenArguments, VarlenManager

# return PipelineStateWAdvance instead of PipelineState
from DLKernel.pipeline import PipelineAsync, make_pipeline_state
import DLKernel.copy_utils as copy_utils
import DLKernel.sm90_utils as dlkernel_sm90_utils
...
class GemmSm90(GemmTmaBase):
    ...
    def __init__(
        ...
        # A-operand transform (DLKernel/operand_transform/): a factory gemm ->
    ...
    def kernel(
        ...
        if warp_idx < self.ab_load_warp_id:
            ...
            # Make fragments
            acc, tCrA, tCrB = dlkernel_sm90_utils.partition_fragment_ABC(
            ...
            if const_expr(not self.mma_is_rs):
                mma_fn = partial(dlkernel_sm90_utils.gemm_w_idx, tiled_mma, acc, tCrA, tCrB)
            else:
    ...
    def canonical_a_load(self, tiled_mma, sA, tidx, tCrA):
        ...
        none)."""
        return dlkernel_sm90_utils.canonical_a_load_s2r(
    ...
    def _make_smem_layouts(
        ...
        if d_dtype is not None:
            epi_smem_layout_staged = dlkernel_sm90_utils.make_smem_layout_epi(
        ...
        if c_dtype is not None:
            ...
            epi_c_smem_layout_staged = dlkernel_sm90_utils.make_smem_layout_epi(
