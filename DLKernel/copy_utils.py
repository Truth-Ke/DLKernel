...
from DLKernel.utils import make_vector
...
def sr_cvt_copy(
    ...
    *,
    ...
    assert isinstance(src.iterator, cute.Pointer) and src.memspace == cute.AddressSpace.rmem
    from DLKernel.rounding import convert_f32_to_bf16_sr, convert_f32_to_f16_sr
    from cutlass.cute.tensor import TensorSSA
...
def cpasync_bulk_s2g(
    ...
    *,
    ...
    # The NVVM ops want a global-space dst; DLKernel gmem pointers are generic-addressed.
