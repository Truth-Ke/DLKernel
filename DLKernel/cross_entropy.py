...
from DLKernel.reduce import row_reduce, online_softmax_reduce
...
@cute_op("dlkernel::cross_entropy_fwd_out", mutates_args={"loss", "lse", "dx"})
...
@cute_op("dlkernel::cross_entropy_bwd_out", mutates_args={"dx"})
