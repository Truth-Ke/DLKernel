...
from DLKernel.pipeline import PipelineStateWAdvance
...
def ag_wait_m_tile(
    ...
    fine-grained FULL flags (see DLKernel/distributed/all_gather_gemm.py module
...
class AgSchedulerArguments(NamedTuple):
    ...
    DLKernel.gemm.AllGatherArguments, same field names (see
    DLKernel/distributed/all_gather_gemm.py). A's M dim is sharded across
