...
space (see DLKernel.operand_transform.kinds.ARG_KINDS), delivered via the aux
...
class TransformAW4(TransformA):
    ...
    def __init__(self, gemm, w4_format):
        ...
        from DLKernel.operand_transform.formats import decode_format
...
# transform's (M, K) index space — see DLKernel.operand_transform.kinds
...
class TransformAValue(TransformA):
    ...
    (see DLKernel.operand_transform.kinds.ARG_KINDS). At
    ...
    built by :func:`DLKernel.operand_transform.host.transform_a_operand`."""
...
class TransformADropout(TransformA):
    ...
    Scheme (see DLKernel/operand_transform/rng.py): the mask of element (m, k)
    ...
    def _gen_pair(self, xw, span, mma_m):
        ...
        from DLKernel.operand_transform import rng
    ...
    def _mask_block(self, frag_i32, xw, b, mma_m):
        ...
        from DLKernel.blockscaled.nvfp4_utils import prmt
