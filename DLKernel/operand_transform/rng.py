...
DLKernel.rounding.philox (4x32, 7 rounds — same engine as the SR epilogue).
...
from DLKernel.blockscaled.nvfp4_utils import asm_i32
from DLKernel.rounding import philox  # noqa: F401  (re-exported for transforms)
