...
from DLKernel.epilogue.mixin import ComposableEpiMixin
from DLKernel.epilogue.ops import Scalar, RowVecLoad, ColVecLoad
...
def apply_linear_epilogue(
    ...
    split-K staged reduction kernel (DLKernel/split_k_reduce.py) so the two apply
