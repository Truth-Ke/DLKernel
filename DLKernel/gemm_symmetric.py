...
from DLKernel.cute_dsl_utils import (
    get_device_capacity,
...
from DLKernel.epilogue.ops import TileStore
from DLKernel.gemm_default_epi import GemmDefaultEpiMixin
...
from DLKernel.tile_scheduler import TriangularTileScheduler
...
def _build_gemm_symmetric_plan(
    ...
    *,
    ...
    batched = A.ndim == 3
    if not batched:
        # Dense 2D (unbatched) operands: trace-time batch append, see DLKernel.gemm.
