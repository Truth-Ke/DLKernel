...
class SplitKMode(IntEnum):
    ...
    The canonical public import path is ``from DLKernel.gemm_interface import SplitKMode``
    ...
    import time, and gemm_interface sits above DLKernel.gemm in the import graph, so
    ...
    # kernel (DLKernel/split_k_reduce.py) sums them in a deterministic order and applies
    # the epilogue.
    SEPARATE = 2
