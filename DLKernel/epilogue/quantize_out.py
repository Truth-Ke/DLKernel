...
Sm100BlockScaleFactorRow/ColStore (see DLKernel/blockscaled/quantize_utils.py for the
contract); the quantize core itself is shared with the fused RMSNorm /
LayerNorm quantized forward through DLKernel.blockscaled.quantize_utils.
...
from DLKernel.epilogue.ops import EpiOp, EpiSmemBytes, _get_lane_warp_layouts
from DLKernel.gemm_tvm_ffi_utils import make_fake_sf_tensor
from DLKernel.reduce import warp_reduce
from DLKernel.blockscaled.quantize_utils import (
    FLT_MAX,
    QUANT_DTYPE_MAX,
    quantize_sf_slots,
    sf_vec_size_for,
...
def sfd_quantize_subtile(
    ...
    # DLKernel.blockscaled.quantize_utils for the cuBLAS/CUTLASS semantics contract).
