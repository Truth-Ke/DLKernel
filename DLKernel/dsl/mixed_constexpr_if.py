...
site-packages; ``DLKernel.dsl.__init__`` installs it before any DLKernel kernel
...
def _install_mixed_constexpr_if_ast_patch() -> None:
    ...
    if getattr(preprocessor_cls, "_dlkernel_mixed_constexpr_if_patch", False):
        return
    ...
    preprocessor_cls._dlkernel_original_visit_If = original_visit_if
    preprocessor_cls.visit_If = visit_if
    preprocessor_cls._dlkernel_mixed_constexpr_if_patch = True
