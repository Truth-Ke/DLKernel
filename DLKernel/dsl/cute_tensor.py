...
``tensor.contiguous()`` mirrors ``DLKernel.copy_utils.contiguous``.
"""
...
_ORIGINAL_TO_ATTR = "_dlkernel_original_to"
_PATCHED_TO_ATTR = "_dlkernel_rmem_tensor_to"
_ORIGINAL_CLONE_ATTR = "_dlkernel_original_clone"
_PATCHED_CLONE_ATTR = "_dlkernel_tensor_clone"
_ORIGINAL_CONTIGUOUS_ATTR = "_dlkernel_original_contiguous"
_PATCHED_CONTIGUOUS_ATTR = "_dlkernel_tensor_contiguous"
...
def patch_cute_tensor() -> None:
    """Monkey patch CuTe tensors with DLKernel convenience methods.
    ...
    equivalent to :func:`DLKernel.copy_utils.contiguous`, and a ``clone`` method
