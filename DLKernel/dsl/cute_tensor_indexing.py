...
The original methods are retained as ``_dlkernel_original_getitem`` and
``_dlkernel_original_setitem`` for debugging or manual rollback.
"""
...
_ORIGINAL_GETITEM_ATTR = "_dlkernel_original_getitem"
_ORIGINAL_SETITEM_ATTR = "_dlkernel_original_setitem"
_PATCHED_ATTR = "_dlkernel_extended_indexing"
